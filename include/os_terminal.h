...
extern "C" {
    ...
    void *terminal_new(const TerminalDisplay *display, float font_size, void *(*malloc)(size_t), void (*free)(void *));
#endif

#if !defined(TERMINAL_EMBEDDED_FONT)
    void *terminal_new(const TerminalDisplay *display, const uint8_t *font_buffer, size_t font_buffer_size, float font_size,
    ...
    void terminal_set_clipboard(void *terminal, const char *(*get_fn)(void), void (*set_fn)(const char *));
